...
const handlePayment = async(e) => {
  console.log(thongtinbosung,"thongtinbosung")
  e.preventDefault();
...
<div className="thanhtoancontainer" style={{display:'flex',margin:'0 auto',justifyContent:'center'}}>
  ...
  <select
    ...
    onChange={(e) => {
      ...
      const selectedCity = cities.find(city => city.code == selectedValue);
      const selectedValueString = selectedCity ? selectedCity.name : '';
...
<div className="form-group" style={{ width: '33%' }}>
  ...
  <select
    ...
    console.log(selectedValue,"selectedValue");
      const selectedDistrict = districts.find(district => district.code == selectedValue);
      const selectedValueString = selectedDistrict ? selectedDistrict.name : '';
...
<div className="form-group" style={{ width: '33%' }}>
  ...
  <select
    ...
    onChange={(e) => {
      const selectedValue = e.target.value;
      const selectedWard = wards.find(ward => ward.code == selectedValue);
      const selectedValueString = selectedWard ? selectedWard.name : '';
